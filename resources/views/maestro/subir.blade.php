          ...
          <div class="modal-body">
              ...
              <div class="row">
               ...
               <div class="form-group col-md-3">
                 ...
                 {!! Form::text('C2',null,['class' => 'form-control', 'placeholder' => 'Calificacion 2', 'required' ] ) !!}
               </div>
               <div class="form-group col-md-3">
                 {!! Form::label('C3', 'Calificacion 3') !!}  
                 {!! Form::text('C3',null,['class' => 'form-control', 'placeholder' => 'Calificacion', 'required' ] ) !!}
               </div>
               <div class="form-group col-md-3">
                 {!! Form::label('C4', 'Calificacion 4') !!}  
                 {!! Form::text('C4',null,['class' => 'form-control', 'placeholder' => 'Calificacion', 'required' ] ) !!}
               </div>
              </div>
